...
public class NaichaCommentbackView extends NaichaCommentbackEntity implements Serializable {
	...
	public NaichaCommentbackView() {

	}

	public NaichaCommentbackView(NaichaCommentbackEntity naichaCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, naichaCommentbackEntity);
