...
public class NaichaCollectionView extends NaichaCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String naichaCollectionValue;
	...
	public NaichaCollectionView() {

	}

	public NaichaCollectionView(NaichaCollectionEntity naichaCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, naichaCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getNaichaCollectionValue() {
				return naichaCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setNaichaCollectionValue(String naichaCollectionValue) {
				this.naichaCollectionValue = naichaCollectionValue;
			}
