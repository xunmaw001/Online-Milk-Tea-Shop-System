...
var centerMenu = [
    ...
    ,{
        name: '奶茶收藏',
        url: '../naichaCollection/list.html'
    }
    ,{
        name: '奶茶订单',
        url: '../naichaOrder/list.html'
    }
...
var adminurl =  "http://localhost:8080/wangshangnaichadian/admin/dist/index.html#/login";
